...
\code{GAME\_DURATION} & 120.0 & Durée totale de la partie, en
    secondes ($=$ \code{DT} $\times$ \code{TOTAL\_TICKS}). \\
\code{TOTAL\_TICKS} & 1200 & Nombre de ticks dans une partie. \\
\bottomrule
\end{longtable}
...
\midrule
\endhead
\code{MOVE\_COOLDOWN} & 2 & Nombre total de ticks pendant lesquels
    \func{move} occupe le robot, y compris le tick où elle réussit. \\
\code{PICKUP\_COOLDOWN} & 5 & Nombre total de ticks pendant lesquels
    \func{pickup} occupe le robot, y compris le tick où elle réussit. \\
\code{SET\_COLOR\_COOLDOWN} & 5 & Nombre total de ticks pendant
    lesquels \func{set\_color} occupe le robot, y compris le tick où elle
    réussit. \\
\code{LAY\_DOWN\_COOLDOWN} & 5 & Nombre total de ticks pendant
...
\midrule
\endhead
\code{INITIAL\_BOXES} & liste de 11 tuples & La disposition de départ
